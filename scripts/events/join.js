...
Raja-Babu কে নক করতে পারেন 
👉FB link: https://www.facebook.com/RAJA.BABU.TERA.REAL.ABBU.OK.07
-
`, attachment: fs.createReadStream(__dirname + "/cache/joinmp4/BADOLKHAN.mp4")} ,threadID));
	}
	else {
		try {
